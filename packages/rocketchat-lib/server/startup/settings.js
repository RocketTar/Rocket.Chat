...
RocketChat.settings.addGroup("Accounts", function() {
	...
	this.section("Accounts_Default_User_Preferences", function() {
		...
		this.add(
			"Accounts_Default_User_Preferences_desktopNotificationDuration",
			0,
			{
				type: "int",
				public: true,
...
RocketChat.settings.addGroup("Email", function() {
	this.section("Subject", function() {
		...
		return this.add(
			...
			"[User] has posted a message in #[Room]",
			{
				type: "code",
				code: "text",
				multiline: true,
	...
	this.section("Header_and_Footer", function() {
		...
		this.add(
			"Email_Footer",
			'</td></tr></table></td></tr><tr><td border="0" cellspacing="0" cellpadding="0" width="100%" style="font-family: Helvetica,Arial,sans-serif; max-width: 800px; margin: 0 auto; padding: 1.5em; text-align: center; font-size: 8pt; color: #999;">Powered by <a href="https://rocket.chat" target="_blank">Rocket.Chat</a></td></tr></table></td></tr></table></html>',
			{
				type: "code",
				code: "text/html",
				multiline: true,
...
RocketChat.settings.addGroup("Layout", function() {
	this.section("Content", function() {
		...
		this.add(
			...
			"Terms of Service <br> Go to APP SETTINGS -> Layout to customize this page.",
			{
				type: "code",
				code: "text/html",
				multiline: true,
		...
		this.add(
			"Layout_Login_Terms",
			'By proceeding you are agreeing to our <a href="terms-of-service">Terms of Service</a> and <a href="privacy-policy">Privacy Policy</a>.',
			{
				type: "string",
				multiline: true,
				public: true
		...
		this.add(
			...
			"Privacy Policy <br> Go to APP SETTINGS -> Layout to customize this page.",
			{
				type: "code",
				code: "text/html",
				multiline: true,
...
RocketChat.settings.addGroup("Logs", function() {
	...
	this.add("Hide_Message_Field_In_Logs", true, {
		type: "boolean",
		public: true
	});
